<template lang="">
  <div class="notifications fixed w-2/12 z-50">
    <div v-for="notification in notifications" class="notification mb-1 bg-white border-gray-300 border p-3 flex items-start shadow-lg rounded-md space-x-2">
      ...
      <div class="flex-1 space-y-1">
        <p class="text-base leading-6 font-medium text-gray-700">Successfull!</p>
        <p class="text-sm leading-5 text-gray-600">{{notification.text}}</p>
      </div>
      <svg class="flex-shrink-0 h-5 w-5 text-gray-400 cursor-pointer" stroke="currentColor" viewBox="0 0 20 20">
